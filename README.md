...
<table align="center">
  ...
  <td>
    ...
    <a href="https://github.com/Shahir-47/Paper-Pulse">Repository</a><br>
        Academic research platform that aggregates papers from major sources, ranks them with neural reranking, builds a knowledge graph, and answers questions using RAG. Built with Next.js, FastAPI, PostgreSQL, Neo4j, OpenAI, Cohere, and AWS.
  </td>
</tr>
<tr>
  <td>🎵</td>
